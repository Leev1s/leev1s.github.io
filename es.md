...
[EN](/) · [中文](/zh/) · [العربية](/ar/) · [Français](/fr/) · [Русский](/ru/) · **Español** · [日本語](/ja/) · [한국어](/ko/)
...
- Contribución a **[RankSEG](https://github.com/rankseg/rankseg)**, un framework de segmentación de imágenes de vanguardia publicado en **NeurIPS** y **JMLR**.
- Integración y optimización de RankSEG en el framework **PaddleSeg**, mejorando el post-procesamiento de inferencia y los mecanismos de registro.
- Configuración y optimización de **entornos Dockerizados** para entrenamiento y evaluación reproducibles de modelos a gran escala.

### **Zhejiang Mingce Asset Management Co., Ltd.**
*Pasante de Arquitectura Cuantitativa (CityUHK Bios Coop) | Sep 2025 – Presente*
*Trading Cuantitativo de Criptomonedas & Desarrollo de Estrategias*
- Desarrollo de un framework de aprendizaje profundo multi-etapa para la **predicción de series temporales de criptomonedas** integrando técnicas de **Reducción de Dimensión Suficiente (SDR)**. Uso de **MAVE**, **OPG** y **KSIR** para extraer direcciones no lineales.
- Diseño de un **mecanismo de paralelismo anidado** escalable para optimizar experimentos de backtesting extensivos. Formulación de una estrategia dinámica de programación de recursos que paraleliza tareas en dimensiones de activos y horizonte temporal, **maximizando la utilización de CPU** y **reduciendo significativamente la carga computacional** para el entrenamiento a gran escala.
