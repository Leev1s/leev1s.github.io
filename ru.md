...
> Личная почта: lev1s at foxmail dot com
...
- Собрал и очистил исторические данные о скачках, коэффициентах и типах ставок, подготовив структурированный набор для анализа.
- Применил статистический вывод, проверку гипотез и статистическое обучение к сценариям **«место»** и **«место Q»**.
...
- Реализовал алгоритмы моделирования и аппроксимации в **MATLAB** с точностью подгонки выше **98%**.
- Переписал ключевые функции подгонки на **C**, обработав более 200 тыс. точек данных и повысив вычислительную эффективность примерно на **300%**.
...
- Построил модель генерации мультиправильных фракталов на основе сложных динамических систем.
- Использовал **Taichi / Python** для GPU-ускорения, получив примерно **100-кратное** улучшение по сравнению с исходной реализацией.
- Реализовал визуализацию в реальном времени и интерактивное управление.

### **Эпидемиологическое моделирование COVID-19**
*Проект математического моделирования | Март 2022*

- Построил модель **SIERR-T**, включающую динамику СМИ и слухов.
- Провёл анализ тональности и распознавание слухов в комментариях Weibo.
...
- Английский *(IELTS 6.0; академическое чтение и профессиональная письменная коммуникация)*
