...
- Résultat SoulTrace : <https://soultrace.app/en/results/48093f7c-7980-4f83-97a2-e5b8df3a103f>

## 🎓 Formation

- **City University of Hong Kong** *(Sept. 2025 – Oct. 2026)*<br>
  *Master of Science en statistique*

- **Qingdao University of Technology** *(Sept. 2020 – Juin 2024)*<br>
...
- Piloté l'ingénierie de recherche et le déploiement de l'algorithme de post-traitement de segmentation d'images [RankSEG](https://github.com/rankseg/rankseg), de la lecture du code source et de la reproduction des expériences à l'adaptation des frameworks, l'intégration de l'inférence et de l'évaluation, et le packaging d'environnements de cluster.
...
- Contribué publiquement à l'écosystème RankSEG avec les [PR #19 pour Transformers](https://github.com/rankseg/rankseg/pull/19), [PR #20 pour l'intégration SAM](https://github.com/rankseg/rankseg/pull/20) et [PR #22 pour la documentation d'intégration](https://github.com/rankseg/rankseg/pull/22), ainsi qu'avec la [PR #2 pour MONAI](https://github.com/rankseg/MONAI/pull/2).

### **Zhejiang Mingce Asset Management Co., Ltd.**
*Stagiaire en architecture quantitative | Sept. 2025 – Avr. 2026*<br>
...
*Initiateur du projet | Oct. 2025 – Déc. 2025*<br>
...
*Membre clé | Subvention de la Fondation Nationale des Sciences Naturelles de Chine*<br>
...
- Analysé les effets des politiques à l'aide des [données OxCGRT](https://www.bsg.ox.ac.uk/research/research-projects/covid-19-government-response-tracker).
...
![Singularity](https://img.shields.io/badge/-Singularity-1D3557?style=flat-square&logo=singularity&logoColor=white)
