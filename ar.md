...
- قدت هندسة البحث ونشر خوارزمية معالجة التجزئة [RankSEG](https://github.com/rankseg/rankseg)، مسؤولاً عن المسار الكامل من قراءة الكود المصدري وإعادة إنتاج التجارب، تكييف أطر التجزئة السائدة، دمج معالجة الاستدلال اللاحقة، وتطوير نصوص التقييم حتى تغليف بيئة الحوسبة العنقودية، مما يرتقي بالخوارزمية من نموذج أولي بحثي إلى شكل هندسي قابل للتكرار والنشر.
- تقدّمت بدمج وتوسيع [RankSEG](https://github.com/rankseg/rankseg) ضمن سير عمل التجزئة الدلالية السائدة؛ شاركت في تكييف أطر mmsegmentation وPaddleSeg، وصمّمت مساعد معالجة لاحقة في فرع Transformers لتمكين تمريرات احتمالية مخرجات النموذج مباشرةً إلى معالجة ما بعد التجزئة الموجّهة بـDice/IoU، داعمةً تحسين نتائج التجزئة دون إعادة تدريب.
...
*متدرب هندسة كمية (CityUHK Bios Coop) | سبتمبر 2025 – أبريل 2026*
...
- بنيت نماذج تعلّم إحصائي لسيناريوهات رهان **المكان** و**رهان المكان Q** باستخدام البيانات التاريخية، منجزاً هندسة المميزات وتدريب النموذج وتقييم النتائج.
