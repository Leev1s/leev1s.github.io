...
> به این سایت خوش آمدید! این صفحه حاوی اطلاعات بیشتری دربارهٔ من است.<br>
> ایمیل شخصی: lev1s at foxmail dot com
...
- مهندسی پژوهش و استقرار الگوریتم پس‌پردازش قطعه‌بندی تصویر [RankSEG](https://github.com/rankseg/rankseg) را پیش بردم؛ از خواندن کد منبع و بازتولید آزمایش تا تطبیق چارچوب، یکپارچه‌سازی استنتاج، ارزیابی و بسته‌بندی محیط کلاستر.
...
- در اکوسیستم RankSEG به‌صورت عمومی از طریق [Transformers PR #19](https://github.com/rankseg/rankseg/pull/19)، [SAM integration PR #20](https://github.com/rankseg/rankseg/pull/20)، [integration documentation PR #22](https://github.com/rankseg/rankseg/pull/22) و [MONAI PR #2](https://github.com/rankseg/MONAI/pull/2) مشارکت کردم؛ همهٔ این تغییرات merge شده‌اند.

### **Zhejiang Mingce Asset Management Co., Ltd.**
*کارآموز معماری کمی | سپتامبر ۲۰۲۵ – آوریل ۲۰۲۶*
*مهندسی پژوهش کمی و زیرساخت دادهٔ دارایی‌های دیجیتال*
...
*پروژهٔ درسی دانشگاه شهری هنگ‌کنگ*

- داده‌های تاریخی مسابقه، ضرایب و انواع شرط‌بندی را جمع‌آوری و پاک‌سازی کردم و یک مجموعه‌دادهٔ تحلیل ساختاریافته ساختم.
- استنباط آماری، آزمون فرضیه و یادگیری آماری را روی سناریوهای place و place-Q به کار بردم.
- این پروژه یک پژوهش درسی کوچک‌مقیاس بود؛ نتایج آن نباید به‌عنوان توانایی پایدار در شرط‌بندی یا بازده زندهٔ معاملاتی تفسیر شود.

### **مطالعهٔ تجربی مقاومت برشی خاک غیراشباع**
*عضو اصلی تیم | پروژهٔ مرتبط با بنیاد ملی علوم طبیعی چین*
[📄 مقالهٔ علمی (Rock and Soil Mechanics)](https://doi.org/10.16285/j.rsm.2022.2005)

- الگوریتم‌های شبیه‌سازی و برازش را در **MATLAB** پیاده‌سازی کردم و دقت برازش مدل بیش از **۹۸٪** بود.
- توابع اصلی برازش را با **C** بازنویسی کردم، از بیش از ۲۰۰ هزار نقطهٔ داده پشتیبانی کردم و کارایی محاسباتی را حدود **۳۰۰٪** بهبود دادم.
...
- یک مدل تولید فراکتال چندقانونی مبتنی بر سیستم‌های دینامیکی پیچیده ساختم.
- با **Taichi / Python** شتاب‌دهی GPU را به کار بردم و نسبت به پیاده‌سازی اصلی حدود **۱۰۰×** بهبود گرفتم.
- رندر بلادرنگ و مصورسازی تعاملی را پیاده‌سازی کردم.

### **مدل‌سازی اپیدمیولوژیک COVID-19**
*پروژهٔ مدل‌سازی ریاضی | مارس ۲۰۲۲*

- یک مدل **SIERR-T** ساختم که پویایی رسانه و شایعه را دربر می‌گیرد.
- روی نظرات ویبو تحلیل احساسات و شناسایی شایعه انجام دادم و اثر سیاست‌ها را با استفاده از [داده‌های OxCGRT](https://www.bsg.ox.ac.uk/research/research-projects/covid-19-government-response-tracker) تحلیل کردم.
...
- انگلیسی *(IELTS 6.0؛ مطالعهٔ دانشگاهی و ارتباط نوشتاری حرفه‌ای)*
