...
色       割合     バー            意味
-------  -------  -------------  ---------------------------------------------
ブラック 40.6%    ████████░░░░   主体性、達成、戦略的実行
ブルー   26.9%    █████░░░░░░░   理解、熟達、分析の深さ
レッド   14.4%    ███░░░░░░░░░   強度、率直さ、プレッシャー耐性
ホワイト 12.7%    ███░░░░░░░░░   構造、秩序、安定
グリーン  5.4%    █░░░░░░░░░░░   つながり、感情への感度、調和
```

私のプロフィールはブラックとブルーが強く、行動と分析を組み合わせる傾向があります。

- ブラックは、推進力、主体性、物事を最後まで進める姿勢として表れます。
- ブルーは、精度、好奇心、システムの実際の仕組みを理解したいという志向を加えます。
- レッドは、プレッシャー、率直な表現、高い強度への一定の許容度を示します。
- ホワイトもありますが二次的で、実行を改善する構造を重視します。
- グリーンは最も控えめで、感情的な雰囲気や合意形成を自然に優先するタイプではありません。

### 中核パターン

難しい問題、現実的な制約、そして明確に考えるための余地があるときに、最も良い仕事ができます。説得力のある説明を作るより、実際に耐えうるシステムを構築することを好みます。

### 参考

- SoulTrace 結果: <https://soultrace.app/en/results/48093f7c-7980-4f83-97a2-e5b8df3a103f>
...
*シティ大学香港 課程プロジェクト*  
- 過去のレース、オッズ、投票タイプのデータを整理・クリーニングし、統計的推論と学習をプレースおよびプレースQのシナリオに適用しました。
...
- **MATLAB** でシミュレーションとフィッティングを実装し、モデルフィット精度 **98%超** を達成しました。主要関数を **C** で書き直し、20万点超に対応しながら計算効率を約 **300%** 改善しました。
- **Python / Origin** で分析・可視化を行い、装置関連の2件の特許成果に貢献しました。

### **マルチルールフラクタル生成の研究**
*卒業論文*  
- 複雑力学系に基づくマルチルール・フラクタルモデルと、リアルタイムのインタラクティブ表示を構築しました。
- **Taichi / Python** で GPU 加速を行い、元の実装に対して約 **100倍** の高速化を達成しました。

### **COVID-19 の疫学モデリング**
*MathorCup 2022*  
- メディアとデマの動態を統合した **$SIERR-T$ モデル** を構築し、Weibo コメントの感情分析とデマ識別を行いました。
- [OxCGRT データ](https://www.bsg.ox.ac.uk/research/research-projects/covid-19-government-response-tracker) を用いて政策効果を分析しました。
